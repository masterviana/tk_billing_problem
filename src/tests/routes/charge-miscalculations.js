var vows = require('vows'),
  configuration = require('../config/config-miscalculations.js'),
...
var suite = vows.describe('Test charge route with some wrong input paramteres, like country cost');
...
suite.addBatch({
  '/charge route test talkdesk_number from UK without forwarded_phone_number': {
    ...
    'with success': function (err, apiCost) {
      assert.notEqual(apiCost, localCost);
    }
  }
